...
class App {
	...
	constructor() {
		btn.addEventListener("click", async () => {
			try {
				...
				this.joke = joke.joke ? joke.joke : `${joke.setup} ${joke.delivery}`;

				await VoiceRSS.speech({
					key: "9a02be9b296b4fcab712ef7259afdf78",
					src: this.joke,
					hl: "en-us",
					v: "Linda",
					r: 0,
	...
	async getJoke() {
		try {
			...
			alert("Couldn't get joke, Try again !");
		}
	}
}
const app = new App();
